<div class="popup" id="popup-remove-showing">
    <div class="popup__container">
        <div class="popup__content">
            ...
            <div class="popup__wrapper">
                <form method="POST" action="" data-remove-form="showing">
                    @csrf
                    @method('DELETE')

                    <p class="conf-step__paragraph">
                        Вы действительно хотите снять с сеанса фильм <span data-remove-title></span>?
                    </p>
